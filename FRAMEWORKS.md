...
![Next.js Auto-Detect Example](images/command_devbind_run_nextjsapp.png)
...
![General pnpm dev execution](images/command_devbind_run_app_pnpm_dev.png)
...
### Allowing Your `.test` Domain (Vite & TanStack Start)
