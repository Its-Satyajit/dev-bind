...
* **gui:** add Help tab and CLI `gui` command to launch UI ([61775a5](https://github.com/Its-Satyajit/dev-bind/commit/61775a505954d926fd8ce8b19a03ed960a128330))
...
* **tests:** add unit tests and dev-tempfile deps for CLI and GUI crates ([8112f01](https://github.com/Its-Satyajit/dev-bind/commit/8112f01e2681ec4d6dbffebdfdab2805caa718be))
...
* **deps:** update rust crate dioxus to 0.7 ([9b58fb3](https://github.com/Its-Satyajit/dev-bind/commit/9b58fb3fd2f34eeda1bb0a2843781609c0ab7ca6))
* **deps:** update rust crate dioxus to 0.7 ([aadc755](https://github.com/Its-Satyajit/dev-bind/commit/aadc755627696bc8798abbdf10090abaa42f4bfb))
